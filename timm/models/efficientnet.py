...
default_cfgs = {
    ...
    'efn_dpu_r128': _cfg(url='', input_size=(3, 128, 128)),
    'efn_dpu_r160': _cfg(url='', input_size=(3, 160, 160)),
    'efn_dpu_r192': _cfg(url='', input_size=(3, 192, 192)),
}
...
@register_model
def efn_dpu_r128(pretrained=False, **kwargs):
    """ EfficientNet-Lite0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_efficientnet_lite(
        'efn_dpu_r128', channel_multiplier=0.68, depth_multiplier=0.48, pretrained=False, **kwargs)
    return model

@register_model
def efn_dpu_r160(pretrained=False, **kwargs):
    """ EfficientNet-Lite0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_efficientnet_lite(
        'efn_dpu_r160', channel_multiplier=0.68, depth_multiplier=0.64, pretrained=False, **kwargs)
    return model

@register_model
def efn_dpu_r192(pretrained=False, **kwargs):
    """ EfficientNet-Lite0 """
    # NOTE for train, drop_rate should be 0.2, drop_path_rate should be 0.2
    kwargs['bn_eps'] = BN_EPS_TF_DEFAULT
    kwargs['pad_type'] = 'same'
    model = _gen_efficientnet_lite(
        'efn_dpu_r192', channel_multiplier=0.68, depth_multiplier=0.82, pretrained=False, **kwargs)
    return model
